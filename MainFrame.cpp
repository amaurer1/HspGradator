...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_COMMAND_RANGE(ID_CURVE_TYPE_LINE_SEGMENTS, ID_CURVE_TYPE_CUBIC_SPLINE, &CMainFrame::OnCurveType)
	ON_UPDATE_COMMAND_UI_RANGE(ID_CURVE_TYPE_LINE_SEGMENTS, ID_CURVE_TYPE_CUBIC_SPLINE, &CMainFrame::OnUpdateCurveType)
